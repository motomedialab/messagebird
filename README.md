# Messagebird notifications channel for Laravel 5.x, 6, 7 & 8
...
This package makes it easy to send [Messagebird SMS notifications](https://github.com/messagebird/php-rest-api) with Laravel 5.x, 6, 7 * 8.
